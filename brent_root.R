...
LeafFluxes_brent_root = function(physcon, atmos, leaf, flux, xa, xb, tol) {
...
a = xa;
b = xb;
flux_fa = TleafFunc(physcon, atmos, leaf, flux, a);
flux = flux_fa$flux
fa = flux_fa$tleaf_dif
flux_fb = TleafFunc(physcon, atmos, leaf, flux, b);
flux = flux_fb$flux
fb = flux_fb$tleaf_dif
