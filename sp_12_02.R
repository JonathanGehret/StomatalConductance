...
# Stomatal_Conductance = function(flux,leaf,params,physcon,atmos)
...
# add physical constants to a dataframe physcon?

# physcon = data.frame(physcon.grav,physcon.tfrz,physcon.sigma,physcon.mmdry,
#                     physcon.mmh2o,physcon.cpd,physcon.cpw,physcon.rgas,
#                     physcon.visc0,physcon.Dh0,physcon.Dv0,physcon.Dc0)
...
# is august-roche-magnus the alternative? 
# with  
# esat = 0.61094^((17.625*(tc))/(tc+237.3)) 
...
# Not sure about switching leaftype!?
